...
import kmeansimplementation.pipeline.KMeansImplModel;
 ...
 */
public class KMeanImpl implements AClustering {

    private KMeansImplEstimator kmeans;
    private KMeansImplModel model;
    ...
    public KMeanImpl(SparkSession sparkSession) {
    ...
    public int getNoCluster() {
        return model.getClusterCenters().size();
    }
    ...
    private void buildCluster(Dataset<Row> ds, ASettings settings) {
        ...
        KMeansImplEstimator km = (KMeansImplEstimator) settings.getModel();
        KMeansImplEstimator kmeans = km
        ...
        KMeansImplModel model = kmeans.fit(ds);
        // Make predictions
    ...
    public String getCenters() {
        ...
        Vector[] centers = model.getClusterCenters().toArray(new Vector[0]);
